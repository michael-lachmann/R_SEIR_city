...
SEIR.sto=function(X,beta,dt=1) {
  ...
  dX1=rbinom(n,dX,1-exp(-p2*dt))             # select between two possible next states for some
  dX2=dX-dX1                    # other possibile state
  X1=X-dX+dX2[o1]+dX1[o2]        # o1 and o2 say what adds to what state
  X1
}
...
SEIR.det=function(X,beta,dt=1) {
  ...
  dX1= dX*(1-exp(-p2*dt))             # select between two possible next states for some
  dX2=dX-dX1                    # other possibile state
  X1=X-dX+dX2[o1]+dX1[o2]        # o1 and o2 say what adds to what state
  X1
}
