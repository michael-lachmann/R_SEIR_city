...
```{r}
N.pat=50
SEIR=make.SEIR.f(N.pat=N.pat)
SEIR.det = SEIR$det
SEIR.sto = SEIR$sto

S=1; E=2; IY=3; IA=4; IH=5; RAY=6; RH=7 ; D=8
X = array(0,c(5,N.pat,2,8))
X[,1,,S] = t(Pop_Metro2)
X[ ,1, ,E] = 10
X[5,-1,,S] = 100
Xt=array(0,c(100,N.pat,8))
bt=c(rep(1.7,30),rep(0.04,70))
worker.n=20; Nar=length(X[3,1,,]); Npop=sum(X[3,1,,])
bt=array(0,c(5,N.pat,5))
bt1=bt; bt1[,1,]=0.2 ; bt1[,-1,]=0.2
bt2=bt; bt2[,1,]=0.01; bt2[,-1,]=0.2
for( i in 1:30) { 
