...
plot( apply( Xt[,  ,IH],1,sum),type="l")
lines(apply( Xt[,-1,IH],1,sum),col=2)
plot( apply( Xt[,  ,IY],1,sum),type="l")
lines(apply( Xt[,-1,IY],1,sum),col=2)
plot( apply( Xt[,  ,RAY],1,sum),type="l")
lines(apply( Xt[,-1,RAY],1,sum),col=2)
plot(Xt[,1,D])
plot(Xt[,2,D])

plot(apply(Xt[,-1,D],1,sum)/apply(Xt[,,D],1,sum),main="Fraction of deaths from LTC")
plot(apply(Xt[,-1,IH],1,sum)/apply(Xt[,,IH],1,sum),main="Fraction in H from LTC")
